            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="logo pull-left">
                        <a href="home/">
                            <img src="views/images/home/logo.png" alt="Technotronic Game RK" />
                        </a>
                    </div>
                ...
                <div class="col-sm-8">
                    <div class="shop-menu pull-right">
                        ...
                        /**
                         * Verifica si no existe la variable de Sesion de Id de Usuario
                         */
                        if(!isset($_SESSION['app_id'])) {
                            ...
                            /**
                             * Muestra el menu superior de la página dependiendo el tipo de usuario que inicia sesion.
                             * @var muestroFavorito. muestra la cantidad de favoritos del usuario que visita la pag.
                             * en caso de ser 0 no la muestra. Viene acompañada de un estilo con border-radius.
                             * 
                             * @var muestroCarro. muestra la cantidad de productos en el carrito del usuario
                             * en caso de ser 0 no la muestra. Viene acompañada de un estilo con border-radius.
                             */
                            if ($cantidadFavoritos != 0) {
                                $muestroFavorito = '
                                <b style="color:#ffffff; background-color:#00b6b4; border:none; border-radius:100%; padding:4px 7px">'
                                    .$cantidadFavoritos.'
                                </b>';
                            } else{
                                $muestroFavorito = '';
                            ...
                            <li>
                                <a href="#">
                                    <i class="fa fa-crosshairs"></i> Caja 
                                </a>
                            </li>
                            <li>
                                <a href="carrito/">
                            ...
                            /**
                             * Imprime el menu superior si esta definida la variable de sesion de Usuario.
                             * Y si el usuario logueado no tiene permisos de Administrador.
                             * @var muestroFavorito. muestra la cantidad de favoritos del usuario que visita la pag.
                             * en caso de ser 0 no la muestra. Viene acompañada de un estilo con border-radius.
                             * 
                             * @var muestroCarro. muestra la cantidad de productos en el carrito del usuario
        ...
        <div class="container">
            <nav role="navigation" class="navbar navbar-inverse">
                ...
                <div id="navbarCollapse" class="collapse navbar-collapse">
                    <?php 
                    /**
                     * Verifica si existe la variable de sesion de usuario.
                     * Verifica si el usuario logeado tiene permisos de Administrador.
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown">
                                ...
                                <ul role="menu" class="dropdown-menu">
                                    <li>
                                        <a href="Reporte-Productos/">
                                            <i class="fa fa-file-pdf-o"></i> Productos
                                        </a>
                                    </li>
                                    <li>
                                        <a href="Reporte-Usuarios/">
                                            <i class="fa fa-file-pdf-o"></i> Usuarios
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <i class="fa fa-file-pdf-o"></i> Compras
                                        </a>
                                    </li>
                                </ul>
                            </li>                        
                    ...
                    <?php   
                        ...
                        <ul class="luis nav navbar-nav">
                            ...
                            <?php 
                            /**
                             * Verifica que hay categorias y luego ejecuta una sentencia preparada.
                             * Si hay categorias hace un SELECT de los id de las subcategorias.
                             * Por lo que primero pinta las categorias y luego las Subcategorías.
                             */
                            if (false != $_categorias){
                                ...
                                foreach ($_categorias as $id_categoria => $array_categoria) {
                                    ...
                                    /**
                                     * Verifica si hay Subcategorias asociadas a la categoria.
                                     * Si es true, las pinta con un bucle y direcciona con la función UrlAmigable.
                                     */
