    ...
    <section class="cart_items">
        <div class="container">
                    ...
                    <div>
                        <ul class="mbr-navbar__items mbr-buttons--active">
                            <li>
                                ...
                                <a class="btn btn-default active" data-toggle="modal" href="?view=categorias&mode=add">
                                    Crear
                                </a>
                            </li>
                        </ul>
            ...
            <div class="row cart_info col-sm-12">
                <div class="cart_info">
                    <div class="titulo_categoria">Crear Categorías</div><br />
                        <div class="cajas">
                        <?php
                            if(isset($_GET['success'])) {
                                echo '<div class="alert alert-dismissible alert-success">
                                <strong>Completado!</strong> La categoria ha sido creada correctamente.
                                </div>';
                            }
