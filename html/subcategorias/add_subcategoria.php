    ...
    <section class="cart_items">
        <div class="container">
                    ...
                    <div>
                        <ul class="mbr-navbar__items mbr-buttons--active">
                            <li>
                                ...
                                <a class="btn btn-default active" data-toggle="modal" href="?view=subcategorias&mode=add">
                                    Crear
                                </a>
                            </li>
                        </ul>
            ...
            <div class="row cart_info col-sm-12">
                <div class="cart_info">
                    <div class="titulo_categoria">Crear Sub-Categorías</div><br />
                        <div class="cajas">
                        <?php
                            if(isset($_GET['success'])) {
                                echo '<div class="alert alert-dismissible alert-success">
                                <strong>Completado!</strong> La sub-categoria ha sido creada correctamente.
                                </div>';
                            }
                        ...
                        ?>
    			          	<form class="form-horizontal" action="?view=subcategorias&mode=add" method="POST" enctype="application/x-www-form-urlencoded">
    			            	<fieldset>
                                    <div class="form-group col-sm-5" onkeypress="return runScriptReg(event)">
    			              		...
    			              		<div class="form-group col-sm-5" onkeypress="return runScriptReg(event)">
    			                		<label for="inputEmail" class="col-lg-2 control-label">Sub-Categoría</label>
    			                		<div class="col-lg-10">
    			                  			<input type="text" class="form-control" name="nombre" placeholder="Nombre para la sub-categoría">
    			                		</div>
    			              		</div>
